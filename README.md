...
- [x] **Market Connect**: Creates a bidding system where faremer inputs the data abt his/her harvest and interested buyers can put their bids. From which, farmer himself can choose who to sell to.
...
- [x] **Smart Farming Assistant**: Menu Driven Chatbot that offers customized fertilizer recommendations based on soil quality and crop needs to optimize growth and yield. It helps uggest the most suitable crops based on soil nutrients, climate, and historical data.


## Datasets

The **Modern Farming Assistant** project provides three key datasets:  the **Plant Disease Identification Dataset** contains 70,295 training and 17,572 validation images covering 38 diseases across 14 crops like Apple, Tomato, and Grape, used to train CNN models for disease detection; the **Crop Recommendation Dataset** (2200 rows) includes soil and environmental factors such as nitrogen, phosphorous, temperature, humidity, and pH to predict the most suitable crops; and the **Fertilizer Recommendation Dataset** offers data on soil quality and crop needs to provide tailored fertilizer suggestions. These datasets can be accessed via the following links:  [Plant Disease Dataset](https://github.com/ravikant-diwakar/AgriSens/tree/master/Datasets),[Crop Recommendation Dataset](https://github.com/OjalSinfh/KisaanUdhavi_CodeHers/blob/master/Datasets/Crop_recommendation.csv), and [Fertilizer Recommendation Dataset](https://github.com/ravikant-diwakar/AgriSens/blob/master/Datasets/Fertilizer_recommendation.csv).
...
## 👨‍💻 CONTRIBUTERS
- [Ojal Singh](https://github.com/OjalSingh)
- [Avni Jain](https://github.com/AMITKUMAR7970)
- [Kushi Poodar](https://github.com/poodarkhushi)
- [Vaanni Raaj](https://github.com/Gauravkumar1741)
- Chiranshee Rustagi
